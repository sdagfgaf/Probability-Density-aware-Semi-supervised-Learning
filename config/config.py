...
def create_parser_from_file(args, name, filepath="./lassl.yaml"):
...
def parse_commandline_args(args, name="LaSSL", filepath="./lassl.yaml"):
    '''
        args = parser.parse_args('')  # running in ipynb
        args = parser.parse_args()  # running in command line
    '''
    if filepath is not None and os.path.exists(filepath) and not os.path.isdir(filepath):
        args = create_parser_from_file(args, name, filepath)
        # args = create_parser_from_file(args, name, filepath).parse_args()
    else:
